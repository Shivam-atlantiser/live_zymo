...
<div id="icon-container">
    ...
    for ($i=37; $i < 91; $i++) { 
      ?>
      <img style="<?php if($i!=37){ echo "display:none"; } ?>" data-src="<?php echo get_template_directory_uri() ?>/videos/banner-2/zymo-banner-<?php echo $i ?>.jpeg" alt="">
      <?php
    }
    ?>
</div>
...
<div class="banner-video">
    <video muted src="<?php echo get_template_directory_uri() ?>/videos/video-part-1.mp4" poster="<?php echo get_template_directory_uri() ?>/videos/video-poster.png" tabindex="0" autobuffer="autobuffer" preload="preload"></video>
</div>
<main class="main" >
                            ...
                            <div  role="listitem" class="brand-cms-item w-dyn-item" style="opacity: 1">
                                <a class="brand-link w-inline-block">
                                    <div class="brand-image-1">
                                        <img data-src="<?php echo $benifit["image"] ?>" class="lazy" alt="">
                                        <?php //echo file_get_contents($benifit["image"]) ?>
                                    </div>
                                    <!-- <img src="<?php echo $benifit["image"] ?>"   class="brand-image-1 " /> -->
                        ...
                        <a href="<?php echo get_term_link($particular) ?>" data-w-id="b70812e3-462b-0f96-d99c-95740492bfa8"  class="service-4-link-block w-inline-block">
                            <div class="service-4-image-1">
                                <div class="image-animation-trigger">
                                    ...
                                    <img data-src="<?php echo z_taxonomy_image_url($particular->term_id);  ?>"  alt="" class="cover-image lazy"/>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="cta-img">
                        ...
                        <img data-src="<?php echo $get_a_quote_section["image"] ?>" class="lazy" alt="">
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section class="section wf-section section-testimonials">
        <div class="container">
            ...
            <div class="padding-inner pt-4em">
                ...
                <div class="view-more-testimonial fadein" data-scroll style="--delay:.5s;">
                <a href="<?php echo home_url("testimonials") ?>" class="main-button w-inline-block fadein" data-scroll>
    ...
    <section data-w-id="5f12009d-ea60-be2a-828c-d21ce38d055e" class="section wf-section section-faqs bg-primary">
          <div class="container">
            <div class="padding-inner">
                      ...
                      <div class="accordion-toggle in-testimonial w-dropdown-toggle " id="w-dropdown-toggle-5"
                        ...
                        <?php echo $q_and_a["question"] ?></p>
                          <div class="accordion-circle"><img
                            src="<?php echo get_template_directory_uri() ?>/images/svg/627d7bf74709d61b5fdfee8b_expand_more_black_24dp.svg"
              ...
              <div class="view-more-faqs fadein" data-scroll style="--delay:.5s;">
